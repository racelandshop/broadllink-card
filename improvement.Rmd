...
### Frontend side:
 ...
 - Implement longpress, so each remote has x2 the number of options
  - Add presets changer to the side of remote instead to the editor card (requires to update configuration from the broadlink code, which does not seem trivial)

### Backend side:
 - Imrpove error handling when discovering devices
